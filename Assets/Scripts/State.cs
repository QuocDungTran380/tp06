...
public class Pursue : State
{
    ...
    public override void Update()
    {
        ...
        if (agent.hasPath)
        {
            ...
            else if (!CanSeePlayer() || distance > 7.0f)
            {
                float timeout = 3f;
...
public class Attack : State
{
    ...
    private float attackCooldownLeft = 0.5f;
    ...
    public override void Update()
    {
        ...
        if (CanAttackPlayer() && attackCooldownLeft <= 0)
        {
            ...
            {
                GameObject.FindGameObjectWithTag("HealthBar").GetComponent<HealthBar>().TakeDamage(20f);
